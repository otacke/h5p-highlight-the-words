...
export default class HighlightTheWordsButton {
   ...
   */
  show() {
    this.button.classList.remove('h5p-highlight-the-words-display-none');
  }
   ...
   */
  hide() {
    this.button.classList.add('h5p-highlight-the-words-display-none');
  }
  ...
  enable() {
    ...
    this.button.classList.remove('h5p-highlight-the-words-button-disabled');
   ...
   */
  disable() {
    this.button.classList.add('h5p-highlight-the-words-button-disabled');
  ...
  activate() {
    ...
    if (this.params.type === 'toggle') {
      this.button.classList.add('h5p-highlight-the-words-button-active');
  ...
  deactivate() {
    ...
    if (this.params.type === 'toggle') {
      this.button.classList.remove('h5p-highlight-the-words-button-active');
